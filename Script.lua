...
RunService.Heartbeat:Connect(function()
    if SpeedEnabled and LocalPlayer.Character then
        local humanoid = LocalPlayer.Character:FindFirstChildOfClass("Humanoid")[span_1](start_span)[span_1](end_span)
        if humanoid then
            humanoid.WalkSpeed = MainSpeed[span_2](start_span)[span_2](end_span)
        end
    end
end)
